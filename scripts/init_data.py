...
products = [
    ...
    Row(product_id=6, product_name="", category="Furniture", price=100000)
]
...
sales = [
    ...
    Row(sale_id=1006, product_id=5, customer_id=506, quantity=1, sale_date="2024-04-04")
]
...
customers = [
    ...
    Row(customer_id=505, customer_name="", loyalty_status="Gold")
]
